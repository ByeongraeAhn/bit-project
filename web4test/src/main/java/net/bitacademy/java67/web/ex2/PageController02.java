 ...
 * - 요청 처리 메서드가 선언하는대로 프론트 컨트롤러라는 값을 넣어준다.
 */
...
public class PageController02 {
  ...
  public String test06(HttpServletRequest request, HttpServletResponse response) {
  ...
  public String test07(String name, int age,  HttpServletRequest request) {
  ...
  // - 프론터 컨트롤러에게 JSP에 전달할 값을 담을 바구니를 요구하라!  brt) 3번과는 다르게 빈바구니를 받아서 서블릿리퀘스트에 직접 옮긴다. 방법은 많다!
  ...
  public String test10(Model model/*,ServletContext ctx*/) {  //이렇게 하면 안된다.
