...
//@Controller // 빈의 이름을 지정하지 않으면 클래스 이름(첫 알파뱃은 소문자)을 사용한다.
              // ex1 패키지에 선언되 PageController01과 이름충돌이 발생한다.
...
public class PageController01 {
  ...
  public ModelAndView test03() {
    ...
    // 프론트 컨트롤러에 의해 ServletReques로 옮겨진다.
    // 따라서 JSP는 EL을 사용하여 가볍게 꺼낼 수 있다.
  ...
  //   리턴 타입이 ResponseEntity 이기 떄문에,
  //   @ResponseBody 애노테이션을 붙일 필요가 없다.
